...
<body class="fix-header card-no-border fix-sidebar">
    ...
    <div id="main-wrapper">
       ...
       <div class="page-wrapper">
           <div class="container-fluid" style="margin-left: 147px;margin-top: 70px;width: 78%;">
            <div class="row page-titles">
                <span style="margin-left: 14px;font-size: 26px;font-weight: 600;">Item</span>
                <div><a href="<?=base_url()?>item/add/<?=$b64_wid?>"><button class="btn btn-warning"  style="margin-left: 845px;margin-top: -57px;background: #5d6bc4;border-color: #5d6bc4;color: #fff;font-size: 13px;border-radius: 1px;border:     border-color: #5d6bc4;">Add Item</button></a>
                  <a href="<?=base_url()?>user"><button class="btn btn-warning"  style="margin-left: 936px;margin-top: -98px;background: #5d6bc4;border-color: #5d6bc4;color: #fff;font-size: 13px;border-radius: 1px;border:     border-color: #5d6bc4;">View All Users</button></a></div>
                                ...
                                <table id="myTable" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                         ...
                                         <!-- <th style="color: #54667a;font-size: 13px;font-weight: bold!important;margin-top: 8px;line-height: 1.5;font-weight: bold;border-bottom: 1px solid rgb(222, 226, 230)!important;border-right: 1px solid rgb(222, 226, 230)!important;">Price</th> -->
                                 ...
                                 <tbody>
                                    ...
                                    $i=1; foreach ($list_data as $key => $list) { ?>
                                        <tr>
                                           ...
                                           <!-- <td style="font-size: 12px;border-radius: 0px;border-bottom: 1px solid #dee2e6!important;border-right: 1px solid #dee2e6!important;color: #54667a;font-weight: 400;line-height: 1.5;"><?=$list['unit_price']?></td> -->
                                           ...
                                           <?php $b64_uid = urlencode(base64_encode($list['item_id']));?>
                                           ...
                                           <td class="text-center" style="border-bottom: 1px solid #dee2e6!important;border-right: 1px solid #dee2e6!important;font-size: 12px">
                                            <a href="<?=base_url();?>item/invoice/<?=$b64_wid?>" data-toggle="tooltip" title="View" style="color: red;font-weight: 700">Invoice</a></td>
                                            
                                            <td class="text-center" style="border-bottom: 1px solid #dee2e6!important;font-size: 12px"><a href="<?=base_url();?>item/delete/<?=$b64_uid?>/<?=$b64_wid?>"  onClick="return confirm('Are you sure you want to delete this item')" data-toggle="tooltip" title="Delete" style="color:#00000;">Delete</a></td>
